<footer class="bg-white border-t border-gray-200 mt-auto">
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-center justify-center gap-2 text-sm text-gray-600">
            <span>© {{ date('Y') }} Developed by <span class="font-semibold text-gray-800">Tahsin Abrar</span></span>
            <span class="hidden sm:inline">•</span>
            <div class="flex items-center gap-4">
                <a href="https://github.com/Tahsin000" target="_blank" rel="noopener noreferrer" 
                ...
                <a href="https://www.linkedin.com/in/tahsin-abrar/" target="_blank" rel="noopener noreferrer"
